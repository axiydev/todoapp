...
class _$_UserModel implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(username: $username, email: $email, uid: $uid, name: $name, datePublished: $datePublished, password: $password, taskNames: $taskNames)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._taskNames, _taskNames));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, username, email, uid, name,
      datePublished, password, const DeepCollectionEquality().hash(_taskNames));
